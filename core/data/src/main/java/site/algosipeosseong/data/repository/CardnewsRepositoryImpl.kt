...
//): CardnewsRepository {
//    override suspend fun getCardnews(): Flow<List<Cardnews>> = flow{ network.getCardnews() }
//
//
//    override suspend fun getCardnewsDetail(cardId: Long): Flow<CardnewsDetail> {
//        network.getCardnewsDetail(cardId = cardId)
//    }
//
//    override suspend fun getCardnewsByCategory(category: Category): Flow<List<CardnewsDetail>> {
//        network.getCardnewsByCategory(category = category)
//    }
//}